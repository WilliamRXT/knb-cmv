...
import type { Product, Ingredient } from "@/types/financial"
...
export function ProductEditForm({ product, onClose }: ProductEditFormProps) {
  const { brands, updateProduct } = useFinancial()
      ...
      <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
          <div>
            ...
            <CardDescription>Edite as informações do produto "{product.name}"</CardDescription>
          </div>
